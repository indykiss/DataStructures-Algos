...
# https://github.com/jwasham/coding-interview-university#how-to-use-it 
...
- Practice & review: Start simple for quick confidence then build up
    ...
    - Trees:
        ...
        - Balanced search trees: AVL, Splay, & Red/Black trees (just the basics)
    - Graphs:
        - Directed & undirected
        - Adjacency matrix
        - Adjacency list
...
- ### Trees - Notes & Background
    - [ ] [Trees (video)](https://www.coursera.org/lecture/data-structures/trees-95qda)
...
- ### Dynamic Programming
    - [ ] [Grokking dynammic programming:](https://www.educative.io/courses/grokking-dynamic-programming-patterns-for-coding-interviews)    
...
- [ ] **ME NEXT**: [Grokking the System Design Interview](https://www.educative.io/courses/grokking-the-system-design-interview)
...
---
    ...
    *****************************************************************************************************
    ...
    Additional Learning that I should look at after basic DS & algos have been refreshed
...
- Videos!: [List of individual Dynamic Programming problems (each is short)](https://www.youtube.com/playlist?list=PLrmLmBdmIlpsHaNTPP_jHHDx_os9ItYXr)
